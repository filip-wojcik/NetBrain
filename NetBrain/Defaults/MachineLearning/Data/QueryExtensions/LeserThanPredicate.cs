...
{
    public class LesserThanPredicate<T> : ComparingPredicate<T>
    {
        public LesserThanPredicate(string name, T expectedValue, IComparer<T> customComparer = null) : base(name, expectedValue, customComparer)
        {
        }
